<template>
  <div class="index">
    <div class="content-head">
      ...
      <el-button type="primary" style="width: 86px;height: 36px;" @click="addSchoolFee">删除</el-button>
      <el-button type="primary" style="width: 86px;height: 36px;" @click="addSchoolFee">入库</el-button>
      <el-button type="primary" style="width: 86px;height: 36px;" @click="addSchoolFee">调度</el-button>
      <el-button type="primary" style="width: 86px;height: 36px;" @click="addSchoolFee">导出</el-button>
    </div>
    <div class="content-head">
      <el-input v-model="input" placeholder="IC卡编号" style="width: 120px;"></el-input>
      <el-input v-model="input" placeholder="企业名称" style="width: 120px;"></el-input>
      <el-input v-model="input" placeholder="IC卡状态" style="width: 120px;"></el-input>
      <el-input v-model="input" placeholder="绑定人姓名" style="width: 120px;"></el-input>
      <el-input v-model="input" placeholder="批次号" style="width: 120px;"></el-input>
      <el-button type="primary" style="width: 86px;height: 36px;" @click="addSchoolFee">查询</el-button>
    </div>
    <div class="comtent-list" style="text-align: center;">
      <el-table :data="schoolFeeData.list" max-height="510">
        ...
        <el-table-column label="IC卡编号" width="120">
          <template scope="scope">
            <span style="margin-left: 10px">{{ scope.row.logo }}</span>
          </template>
        </el-table-column>
        <el-table-column label="企业名称" width="120">
          <template scope="scope">
            <span style="margin-left: 10px">{{ scope.row.name }}</span>
          </template>
        </el-table-column>
        <el-table-column label="绑定人类型" width="120">
          <template scope="scope">
            <span style="margin-left: 10px">{{ scope.row.type}}</span>
          </template>
        </el-table-column>
        <el-table-column label="绑定人姓名" width="120">
          <template scope="scope">
        ...
        <el-table-column label="操作">
          <template scope="scope">
            <el-button type="text" size="small" @click="getRecordList(scope.row)">查看</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
